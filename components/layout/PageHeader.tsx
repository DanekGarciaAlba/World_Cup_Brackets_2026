    ...
    <header className="mb-6 flex flex-col gap-4 lg:mb-8 lg:flex-row lg:items-end lg:justify-between">
      <div className="max-w-4xl">
        <div className="mb-3 flex flex-wrap items-center gap-2">
          <p className="text-xs font-semibold uppercase tracking-[0.18em] text-electric">{eyebrow}</p>
          {badge ? (
        ...
        <h1 className="max-w-5xl text-balance text-[clamp(2rem,4vw,3.8rem)] font-semibold leading-[0.98] tracking-normal">
          {title}
        </h1>
